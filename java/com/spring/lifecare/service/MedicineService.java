...
public interface MedicineService {
	...
	/**
	 * Lists all medicine details.
	 *
	 * @return A page of medicine details.
	 */
	List<MedicineDetail> listAll();

	/**
	 * Lists all medicine details by seller.
	 *
	 * @param sellerId The ID of the seller.
	 * @return A page of medicine details for the specified seller.
	 */
	List<MedicineDetail> listAllBySeller(int sellerId);
	 ...
	 */
	List<MedicineDetail> searchMedicines(User user, String searchTerm);

	/**
	 * Searches for medicine details based on a general search term.
	 *
	 * @param searchTerm The term to search for in medicine details.
	 * @return A page of medicine details matching the search criteria.
	 */
	List<MedicineDetail> searchMedicine(String searchTerm);
